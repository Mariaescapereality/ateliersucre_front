...
import BrownieImage from '@/assets/images/Cadre-croqué-Brownies-1.png';
import BrownieImage2 from '@/assets/images/Cadre-croqué-Brownies-2.png';
import BrownieImage3 from '@/assets/images/Cadre-croqué-Brownies-3.png';
...
const productName = 'Le brownie vegan croquant';
const productDescription = 'Découvrez nos brownies aux noix, un dessert végan irrésistiblement riche en saveurs';
const productPrice = 30;
const productLongDescription = 'Découvrez nos brownies aux noix, un dessert végan irrésistiblement riche en saveurs et mêlant un cœur fondant au croquant des noix. Un dessert pour satisfaire votre envie de chocolat tout en restant dans une alimentation saine !';
...
const allergens = 'Soja, Gluten, Fruits à coque';

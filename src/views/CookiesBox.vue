...
import CookiesImage from '@/assets/images/Cadre-croque-Cookies-1.png';
import CookiesImage2 from '@/assets/images/Cadre-croque-Cookies-2.png';
import CookiesImage3 from '@/assets/images/Cadre-croque-Cookies-3.png';
...
const productName = 'Les cookies aux trois chocolats';
const productDescription = 'Découvrez nos cookies aux trois chocolats';
const productPrice = 10;
const productLongDescription = 'Nos cookies cœur moelleux aux trois chocolats sont une vraie tentation pour les amateurs de chocolat ! Avec leur cœur fondant, ils sont parfaits pour accompagner un café ou un thé.';

...
import CitrontarteImage from '@/assets/images/Cadre-croque-Tarte-citron-1.png';
import CitrontarteImage2 from '@/assets/images/Cadre-croque-Tarte-citron-2.png';
import CitrontarteImage3 from '@/assets/images/Cadre-croque-Tarte-citron-3.png';
...
const productName = 'Les tartelettes au citron meringué';
const productDescription = 'nos tartelettes au citron meringué, un dessert frais';
const productPrice = 30;
const productLongDescription = 'Craquez pour nos tartelettes au citron meringué, un dessert frais et acidulé, surmonté d’une meringue légère et dorée. Une recette facile à réaliser pour les amoureux des agrumes !';

...
import CheesecakeImage from '@/assets/images/Cadre-croque-Tarte-citron-1.png';
import CheesecakeImage2 from '@/assets/images/Cadre-croque-Tarte-citron-2.png';
import CheesecakeImage3 from '@/assets/images/Cadre-croque-Tarte-citron-3.png';
...
const productName = 'Le cheesecake fruits des bois';
const productDescription = 'Découvrez notre cheesecake aux fruits des bois, un dessert crémeux et léger.';
const productPrice = 30;
const productLongDescription = 'Découvrez notre cheesecake aux fruits des bois, un dessert crémeux et léger, parfait pour les amateurs de fruits frais. Sa base croquante de biscuits et sa garniture onctueuse en font une douceur irrésistible.';

...
import EclairsImage from '@/assets/images/Cadre-croqué-eclairs-1.png';
import EclairsImage2 from '@/assets/images/Cadre-croqué-eclairs-2.png';
import EclairsImage3 from '@/assets/images/Cadre-croqué-eclairs-3.png';
...
const productName = 'Le duo d\'éclairs choco-café';
const productDescription = 'Découvrez notre duo d\'éclairs choco-café';
const productPrice = 30;
const productLongDescription = 'Régalez-vous avec nos éclairs choco-café, alliant la richesse du chocolat à la douceur du café. Parfaits pour un goûter ou un dessert raffiné !';

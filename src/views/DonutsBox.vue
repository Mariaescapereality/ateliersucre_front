...
import DonutsImage from '@/assets/images/Cadre-croqué-Donuts-1.png';
import DonutsImage2 from '@/assets/images/Cadre-croqué-Donuts-2.png';
import DonutsImage3 from '@/assets/images/Cadre-croqué-Donuts-3.png';
import DonutsImage4 from '@/assets/images/Cadre-croqué-Donuts-4.png';
...
const productName = 'Les donuts vanille-framboise';
const productDescription = 'Découvrez nos donuts moelleux à la vanille, garnis d\'un coulis de framboise acidulé.';
const productPrice = 30;
const productLongDescription = 'Savourez nos donuts moelleux à la vanille, garnis d\'un coulis de framboise acidulé. Un régal à partager lors de vos pauses gourmandes !';
